...
def test_remaining_trainable_and_sampling_records_live_in_owned_domains() -> None:
    ...
    assert RgcnModelConfig.__module__ == "graph_memory.models.graph_retriever.config.records"
    assert RgcnTrainingConfig.__module__ == "graph_memory.models.graph_retriever.config.records"
