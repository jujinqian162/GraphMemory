...
| `configs/methods/longmemeval_dense_rgcn_graph_retriever.json` | `methods/longmemeval_dense_rgcn_graph_retriever.md` | LongMemEval 专用 Dense-seeded R-GCN 配置，降低 full/cloud-full batch 并提高 epoch。 |
| `configs/methods/longmemeval_dense_ft_rgcn_graph_retriever.json` | `methods/longmemeval_dense_ft_rgcn_graph_retriever.md` | LongMemEval 专用 Dense-FT-seeded R-GCN 配置，降低 full/cloud-full batch 并提高 epoch。 |
