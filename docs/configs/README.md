...
| `configs/methods/learned_graph_rgcn_retriever.json` | `methods/learned_graph_rgcn_retriever.md` | 使用 Dense-FT seed encoder、proposal graph 和 learned edge gate 的 R-GCN trainable graph retriever 当前方法配置。 |
